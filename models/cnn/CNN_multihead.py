...
class CNNmultihead(nn.Module):
    def __init__(self):
        ...
        # Entry 1 for normalized apparent resistivity data
       ...
       # Entry 2 for normalized phase data
    ...
    def forward(self, x, y):
        ...
        #Add the two entries before passing to the dense layers
        out = torch.cat((x, y), dim=1)  

        out = self.relu5(self.fc1(out))
        out = self.fc2(out)
        #For this CNN, the activation function of the last layer is the identity function
        return out
...
class CNNmultihead_with_physics(nn.Module):
    def __init__(self):
        ...
        # Activation functions for the output of dense layers
    ...
    def forward(self, x, y):
        ...
        #normalize output (soft constrain) to 0.01 - 1000 ohm.m and use sigmoid as activation function
